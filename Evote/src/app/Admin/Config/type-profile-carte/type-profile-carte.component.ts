...
import { TypeProfileCarteService } from './TypeProfileCarte.service';

@Component({
  selector: 'app-type-profile-carte',
  templateUrl: './type-profile-carte.component.html',
  styleUrls: ['./type-profile-carte.component.css']
})
export class TypeProfileCarteComponent implements OnInit {

  forms = this.formclient.get(229)
  ...
  constructor(
    private service: TypeProfileCarteService,
